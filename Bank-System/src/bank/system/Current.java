...
{
    public Current(String id, String pin, int ba, int li, String name, String addr, String birth)
    {
        accNo = id;idNo = pin; balance = ba; limit = li; this.name = name; this.addr = addr; this.birth = birth;
    }
